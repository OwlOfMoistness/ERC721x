...
import "@chiru_ups/ERC721AUpgradeable.sol";
import "../LockRegistryUpgradeable.sol";
import "../interfaces/IERC721x.sol";

contract ERC721AxUpgradeable is ERC721AUpgradeable, LockRegistryUpgradeable {
    ...
    function __ERC721Ax_init(string memory name_, string memory symbol_) internal onlyInitializing {
